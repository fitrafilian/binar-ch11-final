...
class Player2 extends React.Component {
  ...
  InsertClick = async () => {
    ...
    if (roomNumber) {
      this.setState({ roomID: roomNumber });
    }

    roomSection.innerHTML = "Room ID: " + roomNumber;
  };
  ...
  RockClick = async () => {
    ...
    const DataPassing = {
      url: "https://binarch9wave12.herokuapp.com/api/multiplier/player2",
      // url: "http://localhost:5000/api/multiplier/player2",
      method: "post",
      data: {
          ...
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-primary" data-dismiss="modal" onClick={this.InsertClick}>
                  Play
                </button>
              </div>
            </div>
          ...
          <div className="main1">
            <div className="container">
              <div className="row justify-content-center align-items-center">
                ...
                >
                  <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#insertRoomID">
                    Insert Room ID
                  </button>
                  <p className="text-center roomID"></p>
                  <div>
                    <p className="text-center m-0">You are Player 2</p>
              ...
              <footer className="d-flex justify-content-center align-items-center m-auto">
                <div className="result">
                  {this.state.match === null ? null : this.state.match.message === "data not found" ? null : (
                    <>
                      <p>
                        Player one choose {this.state.match === null ? null : this.state.match.match.choose1 + ". "}{" "}
                        {this.state.match === null
                          ? null
                          : this.state.match.match.resultUser2 === "DRAW"
                          ? "Match " + this.state.match.match.resultUser2
                          : "You " + this.state.match.match.resultUser2}
                        !
                      </p>
